        ...
        public async Task SeedAsync(ApplicationDbContext dbContext, IServiceProvider serviceProvider)
        {
            if (!dbContext.CastMembers.Any())
            {
                ...
                CastMember castMember1 = new CastMember
                {
                    Id = Guid.NewGuid().ToString(),
                    Name = "Mark Wahlberg",
                    FullBiography = "American actor Mark Wahlberg is one of a handful of respected entertainers who successfully made the transition from teen pop idol to acclaimed actor.",
                ...
                CastMember castMember2 = new CastMember
                {
                    ...
                    FullBiography = "Robert Downey Jr. has evolved into one of the most respected actors in Hollywood. With an amazing list of credits to his name, he has managed to stay new and fresh even after over four decades in the business.",
                ...
                CastMember castMember3 = new CastMember
                {
                    Id = Guid.NewGuid().ToString(),
                    Name = "Sean Anders",
                    FullBiography = "Sean Anders is an American film director and screenwriter.",
                ...
                CastMember castMember4 = new CastMember
                {
                    ...
                    FullBiography = "Director of  Hotel Belgraud, Born with silver lajica.",
